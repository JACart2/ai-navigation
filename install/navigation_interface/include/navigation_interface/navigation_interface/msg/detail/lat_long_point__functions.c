...
navigation_interface__msg__LatLongPoint__init(navigation_interface__msg__LatLongPoint * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    navigation_interface__msg__LatLongPoint__fini(msg);
    return false;
  }
  // latitude
  // longitude
...
navigation_interface__msg__LatLongPoint__create(void)
{
  ...
  navigation_interface__msg__LatLongPoint * msg = (navigation_interface__msg__LatLongPoint *)allocator.allocate(sizeof(navigation_interface__msg__LatLongPoint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(navigation_interface__msg__LatLongPoint));
  bool success = navigation_interface__msg__LatLongPoint__init(msg);
  if (!success) {
...
navigation_interface__msg__LatLongPoint__Sequence__init(navigation_interface__msg__LatLongPoint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  navigation_interface__msg__LatLongPoint * data = NULL;

  if (size) {
    data = (navigation_interface__msg__LatLongPoint *)allocator.zero_allocate(size, sizeof(navigation_interface__msg__LatLongPoint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = navigation_interface__msg__LatLongPoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        navigation_interface__msg__LatLongPoint__fini(&data[i - 1]);
      }
...
navigation_interface__msg__LatLongPoint__Sequence__fini(navigation_interface__msg__LatLongPoint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      navigation_interface__msg__LatLongPoint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  navigation_interface__msg__LatLongPoint__Sequence * array = (navigation_interface__msg__LatLongPoint__Sequence *)allocator.allocate(sizeof(navigation_interface__msg__LatLongPoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = navigation_interface__msg__LatLongPoint__Sequence__init(array, size);
  if (!success) {
...
navigation_interface__msg__LatLongPoint__Sequence__destroy(navigation_interface__msg__LatLongPoint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    navigation_interface__msg__LatLongPoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
navigation_interface__msg__LatLongPoint__Sequence__are_equal(const navigation_interface__msg__LatLongPoint__Sequence * lhs, const navigation_interface__msg__LatLongPoint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!navigation_interface__msg__LatLongPoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  navigation_interface__msg__LatLongPoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(navigation_interface__msg__LatLongPoint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    navigation_interface__msg__LatLongPoint * data =
      (navigation_interface__msg__LatLongPoint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!navigation_interface__msg__LatLongPoint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          navigation_interface__msg__LatLongPoint__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!navigation_interface__msg__LatLongPoint__copy(
