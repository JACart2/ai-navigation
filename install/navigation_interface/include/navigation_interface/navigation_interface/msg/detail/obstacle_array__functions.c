...
navigation_interface__msg__ObstacleArray__init(navigation_interface__msg__ObstacleArray * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    navigation_interface__msg__ObstacleArray__fini(msg);
    return false;
  }
  // obstacles
  if (!navigation_interface__msg__Obstacle__Sequence__init(&msg->obstacles, 0)) {
    navigation_interface__msg__ObstacleArray__fini(msg);
    return false;
  }
  return true;
...
navigation_interface__msg__ObstacleArray__fini(navigation_interface__msg__ObstacleArray * msg)
{
  ...
  // obstacles
  navigation_interface__msg__Obstacle__Sequence__fini(&msg->obstacles);
}
...
navigation_interface__msg__ObstacleArray__are_equal(const navigation_interface__msg__ObstacleArray * lhs, const navigation_interface__msg__ObstacleArray * rhs)
{
  ...
  // obstacles
  if (!navigation_interface__msg__Obstacle__Sequence__are_equal(
  ...
  navigation_interface__msg__ObstacleArray * output)
{
  ...
  // obstacles
  if (!navigation_interface__msg__Obstacle__Sequence__copy(
...
navigation_interface__msg__ObstacleArray__create(void)
{
  ...
  navigation_interface__msg__ObstacleArray * msg = (navigation_interface__msg__ObstacleArray *)allocator.allocate(sizeof(navigation_interface__msg__ObstacleArray), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(navigation_interface__msg__ObstacleArray));
  bool success = navigation_interface__msg__ObstacleArray__init(msg);
  if (!success) {
...
navigation_interface__msg__ObstacleArray__Sequence__init(navigation_interface__msg__ObstacleArray__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  navigation_interface__msg__ObstacleArray * data = NULL;

  if (size) {
    data = (navigation_interface__msg__ObstacleArray *)allocator.zero_allocate(size, sizeof(navigation_interface__msg__ObstacleArray), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = navigation_interface__msg__ObstacleArray__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        navigation_interface__msg__ObstacleArray__fini(&data[i - 1]);
      }
...
navigation_interface__msg__ObstacleArray__Sequence__fini(navigation_interface__msg__ObstacleArray__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      navigation_interface__msg__ObstacleArray__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  navigation_interface__msg__ObstacleArray__Sequence * array = (navigation_interface__msg__ObstacleArray__Sequence *)allocator.allocate(sizeof(navigation_interface__msg__ObstacleArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = navigation_interface__msg__ObstacleArray__Sequence__init(array, size);
  if (!success) {
...
navigation_interface__msg__ObstacleArray__Sequence__destroy(navigation_interface__msg__ObstacleArray__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    navigation_interface__msg__ObstacleArray__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
navigation_interface__msg__ObstacleArray__Sequence__are_equal(const navigation_interface__msg__ObstacleArray__Sequence * lhs, const navigation_interface__msg__ObstacleArray__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!navigation_interface__msg__ObstacleArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  navigation_interface__msg__ObstacleArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(navigation_interface__msg__ObstacleArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    navigation_interface__msg__ObstacleArray * data =
      (navigation_interface__msg__ObstacleArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!navigation_interface__msg__ObstacleArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          navigation_interface__msg__ObstacleArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!navigation_interface__msg__ObstacleArray__copy(
