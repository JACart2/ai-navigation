...
#ifndef NAVIGATION_INTERFACE__MSG__DETAIL__VEHICLE_STATE__TYPE_SUPPORT_H_
#define NAVIGATION_INTERFACE__MSG__DETAIL__VEHICLE_STATE__TYPE_SUPPORT_H_
...
#endif  // NAVIGATION_INTERFACE__MSG__DETAIL__VEHICLE_STATE__TYPE_SUPPORT_H_
