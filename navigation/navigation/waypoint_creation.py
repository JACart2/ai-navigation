...
class WaypointCreation(Node):
    def __init__(self):
        ...
        self.declare_parameter('input_gml_file', './src/ai-navigation/navigation/maps/main_shift4.gml')
        self.declare_parameter('output_gml_file', './navigation/maps/main_shift6.gml')
